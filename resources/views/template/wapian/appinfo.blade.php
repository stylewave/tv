...
<head>
    <meta charset='utf-8' />
    <title>{{config('webset.webname')}}app下载</title> 
    <script>
...
<link rel='stylesheet' href='/apk/main.css' />
...
<div id="doc">
    <div id="cover">
        <div class="topbar">
            <div id="logo">
                <a href="/">
                    <img src="/public/static/wapian/images/logo.png" alt="{{config('webset.webname')}}">
                </a>
            </div>
        </div>
        <div class="header g-clear">
            ...
            <div class="desc">
                <h1 >
                    <img src="/apk/3.png" alt="下载神器，畅看大片！">
                </h1>
                <div class="download clearfix">
                    <div class="down-btns">
                        <a href="" class="btn btn-iphone"></a>
                        <a href="/apk/app.apk" class="btn btn-android"></a>
                    </div>
                    <div class="down-qr">
                        <img src="/apk/code.png">
                        <p>二维码扫描下载</p>
                    </div>
                </div>
            </div>
...
<script src='js/a9600b259c2bcdc3,21ee8b1630148a43,d8cfa61cc5a0fd94,8a17a378a5a6d25a,77ba4a3eec8f69ac,0cac771d2eabbc78,95c50231c725ccec,0fa672543b91f314.js' type='text/javascript'></script>
