        ...
        <div class="row">
            <div class="hy-layout clearfix">
                ...
                <div class="col-lg-5 col-md-6 col-sm-12 padding-0">
                    <div class="hy-index-menu clearfix">
                        <div class="item">
                            <ul class="clearfix">
						 <li><a href="/cxlist.html"><i class="icon iconfont icon-ic_mymatch_ranking text-color"></i><span>影院热映</span></a>
                                </li>
                                <li><a href="/movielist/all/1.html"><i
                                                class="icon iconfont icon-menu1 text-color"></i><span>高清电影</span></a>
                                </li>
                                <li><a href="/tvlist/all/1.html"><i
                                                class="icon iconfont icon-update text-color"></i><span>电视剧集</span></a>
                                </li>
                    ...
                    <div class="hy-right-qrcode hidden-sm hidden-xs">
                        <div class="item">
                            <dl class="clearfix">
                                <dt><img src="{{config('wxconfig.wximg')}}" alt="好看的电影,VIP电影免费看"></dt>
                                <dd>
                                    <h4>扫描二维码可以使用手机观看</h4>
                                    <p class="text-muted">
                                        也可以分享到朋友圈哦！
            ...
            <div class="hy-layout clearfix">
                <div class="hy-video-head">
                    <h3 class="margin-0"><i class="icon iconfont icon-update text-color"></i> 影院热映</h3>
                    <ul class="pull-right">
                                    ...
                                    <div class="col-md-2 col-sm-3 col-xs-4">
                                        <a target="_blank" class="videopic lazy xwcms" href="/play/{{$key}}.html" onclick="jilu(this)"
                                           ...
                                           style="background: url({{$dy['dylogo']}}) no-repeat; background-position:50% 50%; background-size: cover;border-radius: 5px;"><span
                                                    class="play hidden-xs"></span><span class="score" style="font-size: 13px;">VIP会员</span></a>
                                        <div class="title">
